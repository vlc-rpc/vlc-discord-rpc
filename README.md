...
6. If the names you chose in step 4, change them under the iconNames area to be exactly how you named them.
7. Open a terminal, move to the folder you downloaded from this repository, and run `npm i` then run `node .`.
